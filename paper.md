...
![Comparison against reference results of the time-averaged streamwise velocity $u^+$ (left) and $rms$ velocity fluctuations $u_{rms}^{+}$, $v_{rms}^{+}$ and $w_{rms}^{+}$ (right) along the wall-normal direction $y^+$ in wall units.\label{fig:figure_2}](figure_2.png)
<!---
<p align="middle">
...
![Snapshot of the instantaneous streamwise velocity in wall units $u^+$ on a $x^+$-$y^+$ slice from RHEA.\label{fig:figure_3}](figure_3.png)
<!---
<p align="middle">
